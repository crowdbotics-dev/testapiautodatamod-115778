...
## Project Structure
    ...
    ├── testapiautodatamod_115778  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_115778`
...
2. Clone this repo and `cd testapiautodatamod_115778`
